...
Version  : 3.2
Release  : 54
URL      : https://cran.r-project.org/src/contrib/leaps_3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/leaps_3.2.tar.gz
...
%setup -q -n leaps
pushd ..
cp -a leaps buildavx2
popd
pushd ..
cp -a leaps buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718299023
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/leaps/libs/leaps.so
/V4/usr/lib64/R/library/leaps/libs/leaps.so
